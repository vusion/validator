export default {
    ...
    "halfWidth": "必须输入半角字符",
    "hash": "哈希编码不符合{0}算法",
    "hexColor": "必须输入十六进制颜色码",
    "hex": "必须输入十六进制数",
    "identityCard": "必须输入合法的身份证号码",
    "creditCard": "必须输入合法的信用卡号",
    "fqdn": "必须输入合法的全限定域名",
    "ipOrFQDN": "必须输入一个合法IP或全限定域名",
    "isbn": "必须输入合法的国际标准书号",
    "issn": "必须输入合法的国际标准连续出版物编号",
    "isin": "必须输入合法的国际证券识别码",
    "iso8601": "必须输入合法的 ISO8601 日期格式",
    "rfc3339": "必须输入合法的 RFC3339 日期格式",
    "iso31661Alpha2": "必须输入合法的 ISO 3166-1 Alpha-2 国家代码",
    "iso31661Alpha3": "必须输入合法的 ISO 3166-1 Alpha-3 国家代码",
    "json": "必须输入 JSON 格式字符串",
    "jwt": "必须输入合法的 JSON Web Token",
    "latLong": "必须输入合法的经纬度坐标",
    "mobile": "必须输入合法的移动电话号码",
    "mongoId": "必须输入合法的 MongoDB 对象 ID",
