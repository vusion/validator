...
var isNumberStr = function (str) { return /^[-+]?\d+(\.\d+)?$/.test(String(str)); };
/**
...
var hasDuplicates = function (value) {
...
var gte = function (value, target) { return new Decimal(String(value)).gte(new Decimal(String(target))); };
var lte = function (value, target) { return new Decimal(String(value)).lte(new Decimal(String(target))); };
...
var validators = {
    ...
    min: function (value, min) { return gte(value, min); },
    max: function (value, max) { return lte(value, max); },
    range: function (value, min, max) { return lte(min, value) && lte(value, max); },
    pattern: function (value, re) {
        return new RegExp(re).test(value);
    },
    is: function (value, arg) {
    ...
    includes: function (value, arr) {
        return arr.every(function (arg) { return value.includes(arg); });
    },
    excludes: function (value, arr) {
        return !arr.some(function (arg) { return value.includes(arg); });
    },
    ...
    number: function (value) { return typeof value === "number" || isNumberStr(value); },
    numeric: function (value, noSymbols) {
        return $.isNumeric(stringify(value), {
            no_symbols: noSymbols,
        });
    },
    integer: function (value) { return $.isInt(stringify(value)); },
    decimal: function (value, force, digits) {
        return $.isDecimal(stringify(value), {
            force_decimal: force,
    ...
    ip: function (value, version) {
        return $.isIP(stringify(value), version);
    },
    ipRange: function (value, version) {
        return $.isIPRange(stringify(value), version);
    },
    ...
    byteLength: function (value, min, max) {
        return $.isByteLength(stringify(value), { min: min, max: max });
    },
    dataURI: function (value) { return $.isDataURI(stringify(value)); },
    // magnetURI: (value: any): boolean => $.isMagnetURI(stringify(value)), // type丢失
    divisibleBy: function (value, divisor) {
        return $.isDivisibleBy(stringify(value), divisor);
    },
    ...
    hash: function (value, algorithm) {
        return $.isHash(stringify(value), algorithm);
    },
    ...
    ipOrFQDN: function (value) {
        return $.isFQDN(stringify(value)) || $.isIP(stringify(value));
    },
    isbn: function (value, version) {
        return $.isISBN(stringify(value), version);
    },
    issn: function (value) { return $.isISSN(stringify(value)); },
    isin: function (value) { return $.isISIN(stringify(value)); },
    iso8601: function (value, strict) {
        return $.isISO8601(stringify(value), { strict: strict });
    },
    ...
    mobile: function (value, locale, strict) {
        return $.isMobilePhone(stringify(value), locale, { strictMode: strict });
    },
    mongoId: function (value) { return $.isMongoId(stringify(value)); },
    postalCode: function (value, locale) {
        return $.isPostalCode(stringify(value), locale);
    },
    uuid: function (value, version) {
        return $.isUUID(stringify(value), version ? version : "all");
    },
