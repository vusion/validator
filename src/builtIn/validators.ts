...
const validators = {
  ...
  decimal: (value: any, force?: boolean, digits?: string): boolean =>
    $.isDecimal(stringify(value), {
      force_decimal: force,
  ...
  ip: (value: any, version: $.IPVersion): boolean =>
    $.isIP(stringify(value), version),
  ipRange: (value: any, version: $.IPVersion): boolean =>
    $.isIPRange(stringify(value), version),
  ...
  byteLength: (value: any, min: number, max: number): boolean =>
    $.isByteLength(stringify(value), { min, max }),
  dataURI: (value: any): boolean => $.isDataURI(stringify(value)),
  // magnetURI: (value: any): boolean => $.isMagnetURI(stringify(value)), // type丢失
  divisibleBy: (value: any, divisor: number): boolean =>
    $.isDivisibleBy(stringify(value), divisor),
  halfWidth: (value: any): boolean => !$.isFullWidth(stringify(value)),
  fullWidth: (value: any): boolean => !$.isHalfWidth(stringify(value)),
  hash: (value: any, algorithm: any): boolean =>
    $.isHash(stringify(value), algorithm),
  ...
  ipOrFQDN: (value: any): boolean =>
    $.isFQDN(stringify(value)) || $.isIP(stringify(value)),
  isbn: (value: any, version: $.ISBNVersion): boolean =>
    $.isISBN(stringify(value), version),
  issn: (value: any): boolean => $.isISSN(stringify(value)),
  isin: (value: any): boolean => $.isISIN(stringify(value)),
  iso8601: (value: any, strict: boolean): boolean =>
    $.isISO8601(stringify(value), { strict: strict }),
  ...
  uuid: (value: any, version?: any): boolean =>
